...
public class AnalogClockApp extends JFrame {
    ...
    private class ClockPanel extends JPanel
    {
        ...
        protected void paintComponent(Graphics g)
        {
            ...
            drawClockHand(g2d, centerX, centerY, clockRadius * 0.5, hoursAngle, 6, Color.white);
            
            // Draw the minute hand in yellow
            drawClockHand(g2d, centerX, centerY, clockRadius * 0.7, minutesAngle, 4, Color.white);
